...
|---|---|---|
| [`biomedical-reference-architecture.md`](biomedical-reference-architecture.md) | Four-layer reference architecture for clinical and population-health governed-data workflows | Nature Aging (2025) — epilepsy/infectious disease; Scientific Reports (2026) — pediatric sleep-disordered breathing |
