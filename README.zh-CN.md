...
| *医院感染疾病与老年癫痫风险* | Nature Aging，5，2188–2196（2025） | [doi:10.1038/s43587-025-01005-x](https://doi.org/10.1038/s43587-025-01005-x) |
| *腺样体扁桃体切除术后儿童轻度睡眠呼吸障碍的生长与睡眠结局* | Scientific Reports，16，文章号 688（2026） | [doi:10.1038/s41598-025-30271-3](https://doi.org/10.1038/s41598-025-30271-3) |

Nature Aging 和 Scientific Reports 生物医学论文仅作为受治理敏感数据研究的应用领域背景。本仓库不根据论文推断任何作者的个人职责；作者角色以论文正式发表的贡献声明为准。
...
未来十二个月的版本目标、治理模板改进、具体工件反馈流程、可复现验证和公开传播计划见 [`ROADMAP.md`](ROADMAP.md)。所有里程碑均可使用公开、合成或去标识化数据完成，不依赖机构患者数据访问。
